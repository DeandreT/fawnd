...
pub const KEYBOARD_LAYOUT: [&str; TOTAL_KEYS] = [
    // Right nav column (col 15, rows 1-4) verified via `fawnd daemon identify`.
    "ESC", "", "F1", "F2", "F3", "F4", "F5", "F6", "F7", "F8", "F9", "F10", "F11", "F12", "", "", "", "", "", "", "",
    "TILDE", "1", "2", "3", "4", "5", "6", "7", "8", "9", "0", "MINUS", "PLUS", "BACK", "", "HOME", "", "", "", "", "",
    "TAB", "Q", "W", "E", "R", "T", "Y", "U", "I", "O", "P", "BRKTS_L", "BRKTS_R", "SLASH_K29", "", "PGUP", "", "", "", "", "",
    "CAPS", "A", "S", "D", "F", "G", "H", "J", "K", "L", "COLON", "QOTATN", "", "RETURN", "", "PGDN", "", "", "", "", "",
    "SHF_L", "EUR_K45", "Z", "X", "C", "V", "B", "N", "M", "COMMA", "PERIOD", "SLASH", "", "SHF_R", "ARR_UP", "END", "", "", "", "", "",
    "CTRL_L", "WIN_L", "ALT_L", "", "", "", "SPACE", "", "", "", "ALT_R", "FN1", "APP", "", "ARR_L", "ARR_DW", "ARR_R", "", "", "", "",
];
